...
[![License](https://img.shields.io/badge/LICENSE-ALL_RIGHTS_RESERVED-4b5563?style=for-the-badge)](https://github.com/)
...
```Bash
git clone [https://github.com/YOUR_GITHUB_USERNAME/netlag-io.git](https://github.com/YOUR_GITHUB_USERNAME/netlag-io.git)
cd netlag-io
```
